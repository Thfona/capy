...
class Jokes(commands.Cog):
    ...
    # Commands
    @commands.command()
    async def sorte(self, context, *, question):
        responses = ['Com certeza.', 'Decididamente sim.', 'Sem dúvida.', 'Definitivamente.', 'Pode contar com isso.', 'Na minha visão, sim.', 'Provavelmente.', 'Parece que sim.', 'Sim.', 'Tudo indica que sim.', 'A resposta não tá muito clara, tenta de novo depois.',
                     'Me pergunta de novo depois.', 'Melhor eu não te falar agora.', 'Não consigo te responder isso agora.', 'Se concentra e pergunta de novo.', 'Melhor você não contar com isso.', 'Minha resposta é não.', 'Minhas fontes dizem que não.', 'Parece que não.', 'Duvido.']
